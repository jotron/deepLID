...
Da bei diesem Typ von neuronalen Netzwerken alle Knoten miteinander verbunden sind, wird es oft \textit{Fully Connected Neural Network} \index{Fully Connected Neural Network}genannt.
\\
